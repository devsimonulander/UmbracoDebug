...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "d04e0083a61976a6")]
...
#pragma warning disable 0109 // new is redundant
		...
		public new static IPublishedContentType GetModelContentType()
			=> PublishedModelUtility.GetModelContentType(ModelItemType, ModelTypeAlias);
		[global::System.CodeDom.Compiler.GeneratedCodeAttribute("Umbraco.ModelsBuilder.Embedded", "8.18.7")]
		public static IPublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<ProductView, TValue>> selector)
			=> PublishedModelUtility.GetModelPropertyType(GetModelContentType(), selector);
#pragma warning restore 0109

		// ctor
		public ProductView(IPublishedContent content)
			: base(content)
		{ }
